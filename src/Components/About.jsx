    ...
    <div className='flex'>
     ...
     <h1 className=' text-black p-4 rounded-xl text-4xl uppercase font-bold  ml-20 underline mb-28'>Our Team</h1>
      <div className='flex flex-wrap gap-24 justify-center mb-36'>
        ...
        <Card  image={Janhavi} memberName = "Janhavi Maheta" />
        <Card className='h-[350px]' image= {Bramha}memberName = "Bramhanad Tambile" />
        <Card image={Dhanshree} memberName = "Dhanshree Walunj" />
      </div>
    </>
  )
}
